...
export default function PermissionMatrix() {
  ...
  return (
    <>
      <SEO
        title="SharePoint Permission Matrix Generator — Free Online Tool"
        description="Visualize and generate SharePoint permission matrices across sites, libraries, and lists. Export as CSV or Markdown for security audits and compliance. Free, browser-based, no login required."
        url="/tools/permission-matrix"
        type="webapp"
      />
