...
# Remove-PnPListItem -List "${listTitle}" -Identity ${itemId} -Force`
  ...
  return (
    <>
      <SEO
        title="SharePoint REST API Builder — Free Online Tool"
        description="Build SharePoint REST API URLs visually. Select operations, add OData filters, and get ready-to-use code snippets in JavaScript, PnPjs, and PowerShell. No login required."
        url="/tools/rest-api-builder"
        type="webapp"
      />
