...
export default function PnPScriptGenerator() {
  ...
  return (
    <>
      <SEO
        title="PnP PowerShell Script Generator — Free Online Tool"
        description="Generate ready-to-run PnP PowerShell scripts for SharePoint Online. Choose a task — create lists, set permissions, export data, bulk operations — fill in parameters, and copy the script. No login required."
        url="/tools/pnp-script-generator"
        type="webapp"
      />
